  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50">
      ...
      <div className="max-w-7xl w-full mx-auto relative z-50 pointer-events-none">
        <div className="absolute right-4 sm:right-6 lg:right-8 top-10 transform -translate-y-1/2 pointer-events-auto">
          <AICoach />
        </div>
      </div>
      ...
      <footer className="bg-white border-t border-gray-200 py-8">
        <div className="max-w-7xl mx-auto px-4 text-center text-sm text-gray-400">
          <p>&copy; {new Date().getFullYear()} Мастерство управления</p>
        </div>
      </footer>
    </div>
  );
